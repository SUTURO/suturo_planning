...
(defun make-place-action-goal (px py pz ox oy oz ow frameid)
...
(defun ensure-place-action-goal-reached (status px py pz ox oy oz ow frameid)
  (roslisp:ros-warn (place-action) "Status ~a" status)
  status
  px py pz ox oy oz ow frameid
  T)


(defun call-place-action (px py pz ox oy oz ow frameid)
