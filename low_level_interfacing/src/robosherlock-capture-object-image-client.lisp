...
(defun init-robosherlock-capture-object-action-client ()
  ...
  (roslisp:ros-info (init-robosherlock-capture-client)
...
(defun call-robosherlock-capture-object-action (regions-value  viz-value)
  ...
  (roslisp:ros-info (robosherlock-capture-object-client) 
  ...
  (multiple-value-bind 
    ...
    (roslisp:ros-info (robosherlock-capture-object-action) 
