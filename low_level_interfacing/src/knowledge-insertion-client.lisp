...
(let* ((position (roslisp:make-msg "geometry_msgs/Point" (x) 2 (y) 4 (z) 0))
  (orientation (roslisp:make-msg "geometry_msgs/Quaternion" (x) 0 (y) 1 (z) 0 (w) 1))
  (pose (roslisp:make-msg "geometry_msgs/Pose" (position) position (orientation) orientation))
  (header (roslisp:make-msg "std_msgs/Header" (frame_id) "/frame"))
  (objectmessage (roslisp:make-msg "suturo_perception_msgs/ObjectDetectionData"
      (name) "test-object"
  ...
  (detection-data (roslisp:make-msg "knowledge_msgs/StoreObjectInfoGoal"
      (detectionData) (make-array 1 :initial-contents '((objectmessage))))))
