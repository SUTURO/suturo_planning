(defsystem low-level-interfacing
  ...
  ((:module "src"
      ...
      (:file "knowledge-door-client" :depends-on ("package"))
      (:file "knowledge-object-client" :depends-on ("package"))
      (:file "knowledge-surface-client" :depends-on ("package"))
      (:file "knowledge-tts-client" :depends-on ("package"))
      ...
      (:file "wipe-action-client" :depends-on("package"))
      (:file "open-drawer-action-client" :depends-on("package"))
      (:file "robosherlock-client-drawer" :depends-on("package"))
      ))))
