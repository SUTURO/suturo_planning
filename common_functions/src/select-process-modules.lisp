...
(cram-prolog:def-fact-group available-hsr-process-modules (cpm:available-process-module
  ...
  (cram-prolog:<- (cpm:available-process-module hsr-wipe))
  (cram-prolog:<- (cpm:available-process-module hsr-drawer))
  ...
  (cram-prolog:<- 
   ...
   (cram-prolog:<- 
      (cpm:matching-process-module ?desig hsr-wipe)
     (desig:desig-prop ?desig (:type :wiping)))

  (cram-prolog:<- 
      (cpm:matching-process-module ?desig hsr-drawer)
    (desig:desig-prop ?desig (:type :openclose)))
